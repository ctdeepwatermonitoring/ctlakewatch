...
output:
  html_document:
    ...
    css: style.css
params:
  SiteID: Wangumbaug Lake, Tolland County, CT, USA
  MaxDepth: 10
---
  ...
  layout(yaxis = list(autorange = "reversed", 
         ...
         shapes = list(
           ...
           list(type = "line",
                ...
                x1 = "2024-01-01", y1 = params$MaxDepth,
