...
bolton_yearly$yearly_avg <- round(bolton_yearly$yearly_avg, 2)
...
bolton_temp$daily_avg <- round(bolton_temp$daily_avg, 2)
...
box_plot <- ggplot(deep_data, aes(x = "", y = Transparency)) +
  ...
  geom_text(aes(x = 1, y = (bolton_avg - 0.4), label = "Your Lake's Average")) +
  scale_y_reverse()
